...
Purpose: Map the codices currently shipped in the Sovereign Ecosystem Foundation.

## Core Codices
- [[Council Chamber/Codices/Challenge and Illumination Codex]]
- [[Council Chamber/Codices/Contrast Layer Codex]]
- [[Council Chamber/Codices/Conduction Codex]]
...
## Rule
- Add only codices that are actually shipped in the current build.
- Module-owned or user-authored codices should appear here only after they exist.